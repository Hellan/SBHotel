/*! UIkit 2.21.0 | http://www.getuikit.com | (c) 2014 YOOtheme | MIT License */ ! function(t) {
    ...
    t.component("dropdown", {
        ...
        checkDimensions: function() {
            if (this.dropdown.length) {
                ...
                var i = this,
                    e = this.dropdown.css("margin-" + t.langdirection, ""),
                    n = e.show().offset(),
                    o = e.outerWidth(),
...
function(t) {
    ...
    t.component("modal", {
        ...
        e = t.$.isFunction(e) ? e : function() {}, n = t.$.extend(!0, {
            bgclose: !1,
            keyboard: !1,
            modal: !1,
            labels: t.modal.labels
